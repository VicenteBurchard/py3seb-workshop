...
METEO_FILE_PATH = os.path.join(INPUT_FOLDER, "meteo",
                               "GPPFLX_US-slmN_FLUXNET2015_SUBSET_HR.csv")
METEO_DAILY_FILE_PATH = os.path.join(INPUT_FOLDER, "meteo",
                                     "GPPFLX_US-slmN_FLUXNET2015_SUBSET_DD.csv")
LAI_FILE_PATH = os.path.join(INPUT_FOLDER, "canopy", "FLX_US-slmN_FLUXNET2015_AUXCANOPY_DD.csv")
